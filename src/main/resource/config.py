...
class Config(object):
    ...
    AUDIO_GENERATION_BATCH_SIZE = 128
    ...
    AUDIO_GENERATION_NUM_MELS = 32  # number of mel spectrogram bins
    ...
    AUDIO_GENERATION_PICKLED_UNITS_DIR_PATH = os.path.join(ROOT_DIR, "data/pickles")
