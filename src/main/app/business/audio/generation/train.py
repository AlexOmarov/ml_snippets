...
def train(metadata_file: str = Config.METADATA_FILE_PATH,
    ...
    audio_dataset, text_dataset, max_seq_length = _get_datasets(metadata_file, phonemes_file, audio_files_dir,
                                                                tensor_length)
    encoder_layers = 3
    decoder_layers = 2
    post_kernel_size = 5
